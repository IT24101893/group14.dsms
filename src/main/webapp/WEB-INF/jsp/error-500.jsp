    ...
    <div class="h-full bg-gray-100">
        ...
        <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex min-h-[80vh] flex-col justify-center items-center py-16 sm:py-24">
                <p2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Internal Server Error</h1>
                <p class="mt-4 text-base text-gray-500">Sorry, something went wrong on our server.</p>
                <div class="mt-10">
