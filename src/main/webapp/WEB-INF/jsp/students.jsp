                    ...
                    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div class="flex h-16 justify-between">
                            ...
                            <div class="ml-6 flex space-x-8">
                                <a href="/students" class="inline-flex items-center border-b-2 border-indigo-500 px-1 pt-1 text-sm font-medium text-gray-900">Students</a>
        ...
        <div class="mx-auto max-w-7xl p-12 px-16">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-base font-semibold leading-6 text-gray-900">Student List</h1>
                    <p class="mt-2 text-sm text-gray-700">A list of all students including their ID, name, age, phone, and address.</p>
                </div>
                <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <a href="/students/add-student" class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add Student</a>
                </div>
            </div>
                    ...
                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        <table class="min-w-full divide-y divide-gray-300 border border-gray-300">
                            ...
                            <c:forEach var="student" items="${students}">
                                <tr class="divide-x divide-gray-200">
                                    <td class="whitespace-nowrap p-4 text-sm font-medium text-gray-900">${student.id}</td>
                                    <td class="whitespace-nowrap p-4 text-sm text-gray-700">${student.name}</td>
                                    <td class="whitespace-nowrap p-4 text-sm text-gray-700">${student.age}</td>
                                    <td class="whitespace-nowrap p-4 text-sm text-gray-700">${student.phone}</td>
                                    <td class="p-4 text-sm text-gray-700">${student.address}</td>
                                    <td class="whitespace-nowrap p-4 text-sm text-indigo-600 space-x-4">
                                        <a href="/students/edit-student/${student.id}" class="hover:underline">Update</a>
                                        <a href="/students/delete-student/${student.id}" class="hover:underline text-red-600">Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
