                ...
                <div class="space-y-10 divide-y divide-gray-900/10">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-3">
                        <div class="px-4 sm:px-0">
                            <h2 class="text-base font-semibold leading-7 text-gray-900">Add Schedule</h2>
                            <p class="mt-1 text-sm leading-6 text-gray-600">Fill in the schedule details and click save.</p>
                        </div>

                        <form action="/schedules/add-schedule" method="POST" class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                            <div class="px-4 py-6 sm:p-8">
                                <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <select name="type" id="type" required class="block w-full rounded-md border-0 bg-white px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                                                <option value="" disabled selected>Please select a schedule type</option>
                                                <option value="DrivingLessonSchedule">Driving Lesson</option>
                                                <option value="TheoryLessonSchedule">Theory Lesson</option>
                                                <option value="ExamSchedule">Exam</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <input type="datetime-local" name="dateTime" id="dateTime" required class="block w-full rounded-md border-0 bg-white px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <input type="number" name="duration" id="duration" required class="block w-full rounded-md border-0 bg-white px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                                        </div>
                                    </div>
                            ...
                            <div class="flex items-center justify-end gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-8">
                                ...
                                <button type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save Schedule</button>
                            </div>
                        </form>
                    </div>
                </div>
